...
use ruma_api::{
    ...
    AuthScheme, EndpointError, FromHttpBody, IncomingRequest, IncomingResponse, IntoHttpBody,
    Metadata, OutgoingRequest, OutgoingResponse, SendAccessToken,
};
...
impl IncomingRequest for Request {
    type IncomingBody = ResponseBody; // impl FromHttpBody<FromHttpRequestError>;
    type EndpointError = MatrixError;
...
impl FromHttpBody for ResponseBody {
